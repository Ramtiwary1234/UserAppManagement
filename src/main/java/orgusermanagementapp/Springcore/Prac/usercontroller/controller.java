...
public class controller {
	...
	@PostMapping("/save")
	public ResponseEntity<String> createUser(@RequestBody Usermanagemet create) {
		String b2=UserService.createUser(create);
		return new ResponseEntity<String>(b2,HttpStatus.BAD_REQUEST);
	}
	@PutMapping("/userId")
	public ResponseEntity<String> updateUser(@RequestBody Usermanagemet update) {
		String b3=UserService.UpdateUser(update);
		return new ResponseEntity<String>(b3,HttpStatus.OK);
	}
	@PatchMapping("/user/DateOfBirth")
	public ResponseEntity<String> UpdateDateOfBirth(@RequestBody Usermanagemet updatebirth) {
	String b4=UserService.UpdateDateOfBirth(updatebirth);
	...
	@GetMapping("/Alluser")
	public ResponseEntity<List<Usermanagemet>>getAllUser(@RequestBody Usermanagemet getUser){
		List<Usermanagemet> b7 =UserService.getAllUser(getUser);	
